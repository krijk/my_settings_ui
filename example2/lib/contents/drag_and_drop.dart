...
class DragAndDropTreeView extends ConsumerStatefulWidget {
  const DragAndDropTreeView({super.key});

  @override
  DragAndDropTreeViewState createState() => DragAndDropTreeViewState();
}

class DragAndDropTreeViewState extends ConsumerState<DragAndDropTreeView> {
  ...
  Duration watchAnimationDurationSetting(BuildContext context) {
    final bool animateExpansions = ref.watch(settingProvider).state.animateExpansions;
